...
x.AB.NaV.add('BB_Cond_Two_Targets/BangBangController_cond_target1', 'tau_g', 666);
x.AB.CaT.add('BB_Cond_Two_Targets/BangBangController_cond_target2', 'tau_g', 55555);
x.AB.CaS.add('BB_Cond_Two_Targets/BangBangController_cond_target2', 'tau_g', 45454);
x.AB.ACurrent.add('BB_Cond_Two_Targets/BangBangController_cond_target1', 'tau_g', 5000);
x.AB.KCa.add('BB_Cond_Two_Targets/BangBangController_cond_target2', 'tau_g', 1250);
x.AB.Kd.add('BB_Cond_Two_Targets/BangBangController_cond_target1', 'tau_g', 2000);
x.AB.HCurrent.add('BB_Cond_Two_Targets/BangBangController_cond_target1', 'tau_g', 125000);
