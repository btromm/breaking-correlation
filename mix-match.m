...
x.AB.NaV.add('bang-bang-homeostasis/BangBangController_cond', 'tau_g', 666);
x.AB.CaT.add('oleary/IntegralController', 'tau_g', 55555);
x.AB.CaS.add('oleary/IntegralController', 'tau_g', 45454);
x.AB.ACurrent.add('bang-bang-homeostasis/BangBangController_cond', 'tau_g', 5000);
x.AB.KCa.add('bang-bang-homeostasis/BangBangController_cond', 'tau_g', 1250);
x.AB.Kd.add('bang-bang-homeostasis/BangBangController_cond', 'tau_g', 2000);
x.AB.HCurrent.add('bang-bang-homeostasis/BangBangController_cond', 'tau_g', 125000);
