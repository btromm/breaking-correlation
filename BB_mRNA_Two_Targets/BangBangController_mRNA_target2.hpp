...
#ifndef BANGBANGCONTROLLER_MRNA_TARGET2
#define BANGBANGCONTROLLER_MRNA_TARGET2
#include "mechanism.hpp"
#include <limits>

//inherit controller class spec
class BangBangController_mRNA_target2: public mechanism {
...
public:
    ...
    BangBangController_mRNA_target2(double tau_m_, double tau_g_, double m_)
    {
        ...
        if (tau_g<=0) {mexErrMsgTxt("[BangBangController_mRNA_target2] tau_g must be > 0. Perhaps you meant to set it to Inf?\n");}
    }
...
double BangBangController_mRNA_target2::getState(int idx)
{
    if (idx == 1) {return m;}
...
int BangBangController_mRNA_target2::getFullStateSize(){return 2; }


int BangBangController_mRNA_target2::getFullState(double *cont_state, int idx)
{
...
void BangBangController_mRNA_target2::connect(conductance * channel_)
{
...
void BangBangController_mRNA_target2::connect(compartment* comp_)
{
    mexErrMsgTxt("[BangBangController_mRNA_target2] This mechanism cannot connect to a compartment object");
}

void BangBangController_mRNA_target2::connect(synapse* syn_)
{
...
void BangBangController_mRNA_target2::integrate(void)
{
    ...
    {
        case 0:
            mexErrMsgTxt("[BangBangController_mRNA_target2] misconfigured controller. Make sure this object is contained by a conductance or synapse object");
            break;
        ...
        default:
            mexErrMsgTxt("[BangBangController_mRNA_target2] misconfigured controller");
            break;
...
void BangBangController_mRNA_target2::checkSolvers(int k) {
    if (k == 0){
        return;
    } else {
        mexErrMsgTxt("[BangBangController_mRNA_target2] unsupported solver order\n");
    }
}
